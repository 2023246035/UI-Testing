...
var FNToast = class _FNToast {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    styles: [".toast-container[_ngcontent-%COMP%]{position:fixed;top:24px;left:50%;transform:translate(-50%);z-index:9999;width:100%;max-width:336px;display:flex;flex-direction:column;gap:8px;pointer-events:none}.toast[_ngcontent-%COMP%]{display:flex;align-items:center;background:#1c2f40;border-radius:8px;padding:12px;width:336px;max-width:100%;opacity:0;transform:translateY(-20px);transition:all .3s cubic-bezier(.4,0,.2,1);pointer-events:auto}.toast.toast-enter[_ngcontent-%COMP%]{opacity:1;transform:translateY(0)}.toast-info[_ngcontent-%COMP%]{border-left-color:#0067b1;background:linear-gradient(90deg,#0067b126,#1c2f40)}.toast-icon[_ngcontent-%COMP%]{width:20px;height:20px;border-radius:50%;display:flex;align-items:center;justify-content:center;margin-right:8px;flex-shrink:0;background:transparent}.toast-icon[_ngcontent-%COMP%]   fn-icon[_ngcontent-%COMP%]{width:20px;height:20px;display:block}.toast-content[_ngcontent-%COMP%]{flex:1;min-width:0}.toast-message[_ngcontent-%COMP%]{font-size:14px;font-weight:500;line-height:20px;color:#fff;display:block}.toast-close[_ngcontent-%COMP%]{background:none;border:none;font-size:22px;color:#fff;opacity:.7;cursor:pointer;padding:0;margin-left:8px;width:24px;height:24px;display:flex;align-items:center;justify-content:center;flex-shrink:0;transition:opacity .2s;pointer-events:auto}.toast-close[_ngcontent-%COMP%]:hover{opacity:1}.toast.toast-leave[_ngcontent-%COMP%]{opacity:0;transform:translateY(-20px)}"]
  });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FNToast, [{
    ...
    args: [{
      ...
      styles: [".toast-container{position:fixed;top:24px;left:50%;transform:translate(-50%);z-index:9999;width:100%;max-width:336px;display:flex;flex-direction:column;gap:8px;pointer-events:none}.toast{display:flex;align-items:center;background:#1c2f40;border-radius:8px;padding:12px;width:336px;max-width:100%;opacity:0;transform:translateY(-20px);transition:all .3s cubic-bezier(.4,0,.2,1);pointer-events:auto}.toast.toast-enter{opacity:1;transform:translateY(0)}.toast-info{border-left-color:#0067b1;background:linear-gradient(90deg,#0067b126,#1c2f40)}.toast-icon{width:20px;height:20px;border-radius:50%;display:flex;align-items:center;justify-content:center;margin-right:8px;flex-shrink:0;background:transparent}.toast-icon fn-icon{width:20px;height:20px;display:block}.toast-content{flex:1;min-width:0}.toast-message{font-size:14px;font-weight:500;line-height:20px;color:#fff;display:block}.toast-close{background:none;border:none;font-size:22px;color:#fff;opacity:.7;cursor:pointer;padding:0;margin-left:8px;width:24px;height:24px;display:flex;align-items:center;justify-content:center;flex-shrink:0;transition:opacity .2s;pointer-events:auto}.toast-close:hover{opacity:1}.toast.toast-leave{opacity:0;transform:translateY(-20px)}\n"]
    }]
  }], () => [], null);
})();
export {
