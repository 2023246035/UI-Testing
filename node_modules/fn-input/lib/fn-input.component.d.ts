...
import { FNInputBase, FNInputHelper, FNInputToast } from './fn-input.types';
import * as i0 from "@angular/core";
export type TypeIconSizeName = 'extrasmall' | 'small' | 'medium' | 'large' | 'x-large' | 'xxlarge';
export declare class FNInput implements OnInit, AfterViewInit, OnDestroy {
    private readonly cdr;
    field: FNInputBase;
    helperHandle?: FNInputHelper;
    toastService?: FNInputToast;
    private readonly injectedToastService;
    ...
    fieldBlur: EventEmitter<any>;
    translateService: TranslateService;
    hasFocus: import("@angular/core").WritableSignal<boolean>;
    textareaElement: ElementRef<HTMLTextAreaElement>;
    toasts: import("@angular/core").WritableSignal<any[]>;
    ...
    private get alphanumericPattern();
    isDisabled: boolean;
    control: FormControl;
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    private setupFieldMessageListener;
    ngAfterViewInit(): void;
    enforceLowercase(event: Event): void;
    /**
    ...
    onFocus(): void;
    private formatInitialCurrencyValue;
    initFormControl(): void;
    autoResizeInitial(): void;
    ...
    handleBlur(e: Event, maxDecimals?: number): void;
    /**
     ...
     */
    private formatDecimalPlaces;
    handleNumberInput(event: Event, maxDecimals?: number): void;
    /**
     ...
     */
    handleNumberPaste(event: ClipboardEvent, maxDecimals?: number): void;
    /**
     * Filter pasted text for currency input (allows digits and decimal point)
     */
    private getFilteredCurrencyPastedText;
    /**
     * Filter pasted text for integer-only input (allows digits only)
     */
    private getFilteredIntegerPastedText;
    /**
     ...
     */
    private applyDecimalRestrictions;
    /**
     * Validate integer digit limit and set/clear errors
     */
    private validateIntegerDigits;
    /**
     * Set max integer digits error
     */
    private setMaxIntegerDigitsError;
    /**
     * Clear max integer digits error if present
     */
    private clearMaxIntegerDigitsError;
    /**
     * Clear numeric error if present
     */
    private clearNumericError;
    /**
     * Set cursor position after paste operation
     */
    private setCursorAfterPaste;
    formatCurrencyWithCommas(value: number | string, maxDecimals?: number): string;
    handleNumberKeydown(event: KeyboardEvent, isCurrency: boolean): void;
...
//# sourceMappingURL=fn-input.component.d.ts.map